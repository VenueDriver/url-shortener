Feature: Dashboard Management
  ...
  Scenario: Admin logs into the dashboard and creates a short URL
    ...
    Then I should see "New example.org URL"
    ...
    Then I should have 1 Shorted URL with domain name as "example.org"
    When I go to homepage
    Then I should see "example.org/blah"
