...
ActiveRecord::Schema.define(version: 20150128210921) do
  ...
  add_index "shortened_urls", ["unique_key", "domain_name"], name: "index_shortened_urls_on_unique_key", unique: true, using: :btree
